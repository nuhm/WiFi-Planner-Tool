							...
							{isConfigSidebarOpen &&
								...
								selected.ap == null && (
									<>
										...
										<p>
											Select an item with the selector tool to view its
											configuration.
										</p>
									</>
								)}
							...
							{isConfigSidebarOpen && selected.ap && (
								<>
									...
									<input
										...
										onChange={(e) => {
											...
											setAccessPoints((prev) => {
												...
												const newAP = updated.find(
													(ap) => ap.id === selected.ap?.id
												);
									...
									<select
										...
										onChange={(e) =>
											updateAPConfig('frequency', e.target.value)
										}
										disabled
									>
									...
									<select
										...
										onChange={(e) =>
											updateAPConfig('antennaType', e.target.value)
										}
										disabled
									>
